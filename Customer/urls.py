...
urlpatterns = [
   ...
   path('inquire_reprieve/',views.inquire_reprieve,name='inquire_reprieve'),
   path('reprieve_detail/<int:id>/',views.reprieve_detail,name='reprieve_detail'),
   path('add_reprieve_detail/<int:id>/',views.add_reprieve_detail,name='add_reprieve_detail'),
   path('update_reprieve_detail/',views.update_reprieve_detail,name='update_reprieve_detail'),
   path('delete_reprieve_detail/',views.delete_reprieve_detail,name='delete_reprieve_detail'),
