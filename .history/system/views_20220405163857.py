...
def send_email(request):
    try:
        ...
        html ="""
                <html>
                    <body>
                        尊敬的用户,请前往激活账号<a href="http://127.0.0.1:8000/system/login_register/?username={}&code={}&timestamp={}">127.0.0.1:8000/system/login_register/?username={}&code={}}&timestamp={}</a>
                    </body>
                <html>
            """.format(username,code,timestamp,username,code,timestamp)
        #构建一个发送内容对象
