...
def send_email(request):
    try:
        ...
        html ="""
                <html>
                    <body>
                            尊敬的用户,请前往激活账号<a href="http://127.0.0.1:8000/system/login_register/?username={0}&code={1}&timestamp={2}">127.0.0.1:8000/system/login_register/?username={0}&amp;code={1}}&amp:timestamp={2}</a>
                    </body>
                <html>
