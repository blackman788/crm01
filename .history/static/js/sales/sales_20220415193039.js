...
$('#sales_update').dialog({
    ...
    buttons:[{
            ...
            handler:function(){
                ...
                $('#update_assignName_hidden').val( $('#update_username_select').find('option:selected').text())
                console.log($('#update_customerName_hidden').val())
                console.log($('#update_linkManName_hidden').val())
                console.log($('#update_assignName_hidden').val())
                //update_sumbit()
