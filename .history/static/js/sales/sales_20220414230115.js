    ...
    if(0 == idx.length){
     ...
     $.ajax({
         ...
         'success':function(result){
            ...
            $('#update_customer_select').val(object.)
            $('#update_chanceSource').val(object.)
            $('#update_linkman_select').val(object.)
            $('#update_linkPhone').val(object.)
            $('#update_cgjl').val(object.)
            $('#update_overview').val(object.)
            $('#update_description').text(object.)
            $('#update_username_select').val(object.)
         },
         'error':function(result){
            console.log(result)
         }
