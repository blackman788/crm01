            ...
            if(result.code == 200){
                ...
                if(result.cs.length >0){
                    ...
                    for(var i=0;i<=result.cs.length;i++){
                        $('#customer_select').append('<option value=" ' + result.cs[i].id+' ">' + result.cs[i].linkName + '</option>')
                ...
                if(result.ls.length >0){
                    ...
                    pass
                    for(var i=0;i<=result.cs.length;i++){
                        $('#linkman_select').append('<option value=" ' + result.ls[i].id+' ">' + result.ls[i].linkName + '</option>')
